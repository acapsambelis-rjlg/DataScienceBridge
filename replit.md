...
- **Integrated Python editor** with syntax highlighting, line numbers, syntax checking, code snippets, autocomplete, bracket matching, current line highlight, and auto-indentation
